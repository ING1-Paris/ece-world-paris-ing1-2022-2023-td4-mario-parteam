...
void explosion(t_joueur perso[],t_bombe bombej1[],t_bombe bombej2[],int matrice[X][Y],int *nbbombe,int *nbbombe2,BITMAP *page,BITMAP *bombe[4],BITMAP *Feu[3],BITMAP *Object[NBOBJECTS],BITMAP *stage);
